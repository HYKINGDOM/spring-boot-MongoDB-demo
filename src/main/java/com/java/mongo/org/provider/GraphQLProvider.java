package com.java.mongo.org.provider;


import com.java.mongo.org.datafetchers.GraphQLDataFetchers;
import com.java.mongo.org.datafetchers.UserDataFetcher;
...
public class GraphQLProvider {
    ...
    public GraphQL graphQL() throws IOException {
        ...
        for (String str : schemaArr) {
            typeRegistry.merge(schemaParser.parse(new ClassPathResource("graphqls/" + str + ".graphql").getInputStream()));
        }
